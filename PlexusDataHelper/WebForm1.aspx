...
<head runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="css/PStyleSheet.css" />
</head>
<body>
    <h1 style="color: #CC0099;">Plexus Reporter</h1>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:FileUpload ID="FileUpload1" cssclass="text-input" runat="server" />
        <input type="submit" id="Submit1" value="Upload" runat="server" />
         <asp:Label ID="Label1" runat="server" CssClass="plabel" Text="Total Points:"></asp:Label>
        <asp:TextBox ID="TextBox_TotPoints" cssclass="text-input" Text= "<%= TotalPoints %>" runat="server"></asp:TextBox>
         <br/>
         <br/>
